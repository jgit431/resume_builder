...
export const TEMPLATES = [
  ...
  },
  {
    id: 'elegant',
    name: 'Elegant',
    description: 'Garamond serif, airy line height, centered. Refined and graceful.',
    styles: {
      personal:   { headerAlign: 'center', showIcons: false },
      experience: { fontFamily: 'Garamond, serif', fontSize: 13, bulletSpacing: 5 },
      education:  { fontFamily: 'Garamond, serif', fontSize: 13 },
      skills:     { separator: 'marker' },
    },
    pageSettings: { marginTop: 1.0, marginBottom: 1.0, marginLeft: 1.25, marginRight: 1.25, lineHeight: 1.9, colorAccents: true },
  },
  {
    id: 'compact',
    name: 'Compact',
    description: 'Dense layout with small font. Fits more on one page.',
    styles: {
      personal:   { headerAlign: 'left', showIcons: true },
      experience: { fontFamily: 'DM Sans', fontSize: 11, bulletSpacing: 1 },
      education:  { fontFamily: 'DM Sans', fontSize: 11 },
      skills:     { separator: 'comma' },
    },
    pageSettings: { marginTop: 0.5, marginBottom: 0.5, marginLeft: 0.5, marginRight: 0.5, lineHeight: 1.4, colorAccents: true },
  },
  {
    id: 'bold',
    name: 'Bold',
    description: 'Right-aligned header, marker skills, high contrast.',
    styles: {
      personal:   { headerAlign: 'right', showIcons: true },
      experience: { fontFamily: 'DM Sans', fontSize: 13, bulletSpacing: 4 },
      education:  { fontFamily: 'DM Sans', fontSize: 13 },
      skills:     { separator: 'marker' },
    },
    pageSettings: { marginTop: 0.75, marginBottom: 0.75, marginLeft: 0.75, marginRight: 0.75, lineHeight: 1.65, colorAccents: true },
  },
  {
    id: 'spacious',
    name: 'Spacious',
    description: 'Wide margins and generous spacing. Easy on the eye.',
    styles: {
      personal:   { headerAlign: 'left', showIcons: true },
      experience: { fontFamily: 'DM Sans', fontSize: 13, bulletSpacing: 6 },
      education:  { fontFamily: 'DM Sans', fontSize: 13 },
      skills:     { separator: 'comma' },
    },
    pageSettings: { marginTop: 1.25, marginBottom: 1.25, marginLeft: 1.25, marginRight: 1.25, lineHeight: 1.8, colorAccents: true },
  },
  {
    id: 'traditional',
    name: 'Traditional',
    description: 'Times New Roman, left-aligned, classic proportions.',
    styles: {
      personal:   { headerAlign: 'left', showIcons: false },
      experience: { fontFamily: 'Times New Roman', fontSize: 13, bulletSpacing: 3 },
      education:  { fontFamily: 'Times New Roman', fontSize: 13 },
      skills:     { separator: 'comma' },
    },
    pageSettings: { marginTop: 1.0, marginBottom: 1.0, marginLeft: 1.0, marginRight: 1.0, lineHeight: 1.6, colorAccents: false },
  },
  {
    id: 'contemporary',
    name: 'Contemporary',
    description: 'Centered, marker skills, relaxed spacing. Fresh and approachable.',
    styles: {
      personal:   { headerAlign: 'center', showIcons: true },
      experience: { fontFamily: 'DM Sans', fontSize: 13, bulletSpacing: 4 },
      education:  { fontFamily: 'DM Sans', fontSize: 13 },
    ...
    pageSettings: { marginTop: 1.0, marginBottom: 1.0, marginLeft: 1.0, marginRight: 1.0, lineHeight: 1.75, colorAccents: true },
  },
  {
    id: 'clean',
    name: 'Clean',
    description: 'Helvetica, no icons, no color. Pure and professional.',
    styles: {
      personal:   { headerAlign: 'left', showIcons: false },
      experience: { fontFamily: 'Helvetica, Arial, sans-serif', fontSize: 13, bulletSpacing: 3 },
      education:  { fontFamily: 'Helvetica, Arial, sans-serif', fontSize: 13 },
      skills:     { separator: 'comma' },
    },
    pageSettings: { marginTop: 1.0, marginBottom: 1.0, marginLeft: 1.0, marginRight: 1.0, lineHeight: 1.6, colorAccents: false },
  },
  {
    id: 'sophisticated',
    name: 'Sophisticated',
    description: 'Georgia, right-aligned, no icons. Confident and polished.',
    styles: {
      personal:   { headerAlign: 'right', showIcons: false },
      experience: { fontFamily: 'Georgia', fontSize: 13, bulletSpacing: 4 },
      education:  { fontFamily: 'Georgia', fontSize: 13 },
      skills:     { separator: 'comma' },
    },
    pageSettings: { marginTop: 1.0, marginBottom: 1.0, marginLeft: 1.0, marginRight: 1.0, lineHeight: 1.7, colorAccents: false },
  },
  {
    id: 'sharp',
    name: 'Sharp',
    description: 'Tight spacing, small font, left-aligned. Precise and efficient.',
    styles: {
      personal:   { headerAlign: 'left', showIcons: true },
      experience: { fontFamily: 'DM Sans', fontSize: 12, bulletSpacing: 2 },
      education:  { fontFamily: 'DM Sans', fontSize: 12 },
    ...
    pageSettings: { marginTop: 0.75, marginBottom: 0.75, marginLeft: 0.75, marginRight: 0.75, lineHeight: 1.5, colorAccents: true },
  },
  {
    id: 'airy',
    name: 'Airy',
    description: 'Garamond, wide margins, tall line height. Light and readable.',
    styles: {
      personal:   { headerAlign: 'left', showIcons: true },
      experience: { fontFamily: 'Garamond, serif', fontSize: 13, bulletSpacing: 6 },
      education:  { fontFamily: 'Garamond, serif', fontSize: 13 },
      skills:     { separator: 'comma' },
    },
    pageSettings: { marginTop: 1.25, marginBottom: 1.25, marginLeft: 1.0, marginRight: 1.0, lineHeight: 2.0, colorAccents: false },
  },
  {
    id: 'helvetica-centered',
    name: 'Crisp',
    description: 'Helvetica, centered header, marker skills. Modern and neutral.',
    styles: {
      personal:   { headerAlign: 'center', showIcons: true },
      experience: { fontFamily: 'Helvetica, Arial, sans-serif', fontSize: 13, bulletSpacing: 3 },
      education:  { fontFamily: 'Helvetica, Arial, sans-serif', fontSize: 13 },
    ...
    pageSettings: { marginTop: 0.75, marginBottom: 0.75, marginLeft: 0.75, marginRight: 0.75, lineHeight: 1.6, colorAccents: true },
  },
  {
    id: 'courier',
    name: 'Technical',
    description: 'Courier monospace, left-aligned. Great for technical roles.',
    styles: {
      personal:   { headerAlign: 'left', showIcons: false },
      experience: { fontFamily: 'Courier New, monospace', fontSize: 12, bulletSpacing: 2 },
      education:  { fontFamily: 'Courier New, monospace', fontSize: 12 },
      skills:     { separator: 'comma' },
    },
    pageSettings: { marginTop: 1.0, marginBottom: 1.0, marginLeft: 1.0, marginRight: 1.0, lineHeight: 1.6, colorAccents: false },
  },
