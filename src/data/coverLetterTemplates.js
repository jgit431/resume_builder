export const COVER_LETTER_TEMPLATES = [
  {
    ...
    styles: { headerAlign: 'left', colorScheme: 'teal' },
    pageSettings: { marginTop: 1.0, marginBottom: 1.0, marginLeft: 1.0, marginRight: 1.0, lineHeight: 1.6, colorScheme: 'teal', bodyFont: 'DM Sans' },
  },
  {
    id: 'modern-cl',
    ...
    styles: { headerAlign: 'center', colorScheme: 'teal' },
    pageSettings: { marginTop: 0.75, marginBottom: 0.75, marginLeft: 0.75, marginRight: 0.75, lineHeight: 1.7, colorScheme: 'teal', bodyFont: 'DM Sans' },
  },
  {
    id: 'executive-cl',
    ...
    styles: { headerAlign: 'center', colorScheme: 'none' },
    pageSettings: { marginTop: 1.0, marginBottom: 1.0, marginLeft: 1.25, marginRight: 1.25, lineHeight: 1.8, colorScheme: 'none', bodyFont: 'Georgia' },
  },
  {
    id: 'minimal-cl',
    ...
    styles: { headerAlign: 'left', colorScheme: 'none' },
    pageSettings: { marginTop: 0.75, marginBottom: 0.75, marginLeft: 0.75, marginRight: 0.75, lineHeight: 1.5, colorScheme: 'none', bodyFont: 'DM Sans' },
  },
  {
    id: 'sidebar-cl',
    ...
    styles: { headerAlign: 'left', colorScheme: 'teal' },
    pageSettings: { marginTop: 0.75, marginBottom: 0.75, marginLeft: 0.75, marginRight: 0.75, lineHeight: 1.6, colorScheme: 'teal', bodyFont: 'DM Sans' },
  },
  {
    ...
    styles: { headerAlign: 'center', colorScheme: 'none' },
    pageSettings: { marginTop: 1.0, marginBottom: 1.0, marginLeft: 1.0, marginRight: 1.0, lineHeight: 1.7, colorScheme: 'none', bodyFont: 'Georgia' },
  },
];
...
export function CoverLetterTemplateSVG({ template }) {
  ...
  return (
    <svg viewBox={`0 0 ${W} ${H}`} xmlns="http://www.w3.org/2000/svg" style={{ display: 'block', width: '100%', height: '100%' }}>
      ...
      <rect x={nameX} y={10} width={nameW} height={serif ? 7 : 6} rx={serif ? 0.5 : 1} fill="#1a1a1a"/>
      <rect x={contactX} y={20} width={contactW} height={2} rx={0.5} fill="#aaa"/>
      <rect x={mx} y={28} width={cw} height={noColor ? 1.5 : 1} fill={noColor ? '#1a1a1a' : color}/>
      ...
      {bodyLines.map((w, i) => (
        <rect key={i} x={mx} y={61 + i * 5.5} width={w} height={2.5} rx={0.5} fill="#ddd"/>
      ))}
